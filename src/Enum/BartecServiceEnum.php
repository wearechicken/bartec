...
namespace wearechicken\Bartec\Enum;
...
class BartecServiceEnum
{
    ...
    const EXTENDED_DATA_FIELD_CLINICAL_WASTE = 'Clinical waste';
    ...
    const EXTENDED_DATA_FIELD_HAS_THE_REST_OF_THE_STREET_BEEN_COLLECTED = 'Has the rest of the street been collected?';
    const EXTENDED_DATA_FIELD_HOUSEHOLD_REFUSE_SACK_COLLECTION = 'Household refuse sack collection';
    const EXTENDED_DATA_FIELD_IS_IT_IN_THE_CORRECT_CONTAINER = 'Is it in the correct container?';
    const EXTENDED_DATA_FIELD_IS_THE_BIN_FULL = 'Is the bin full?';
    const EXTENDED_DATA_FIELD_PAPER_RECYCLING_COLLECTION = 'Paper recycling collection';
    const EXTENDED_DATA_FIELD_PLASTIC_RECYCLING_COLLECTION = 'Plastic recycling collection';
    const EXTENDED_DATA_FIELD_RECYCLING_BOX_COLLECTION = 'Recycling Box collection';
    const EXTENDED_DATA_FIELD_WAS_IT_IN_THE_CORRECT_COLLECTION_POINT = 'Was it in the correct collection point?';
    const EXTENDED_DATA_FIELD_WAS_IT_OUT_BEFORE_7AM = 'Was it out before 7am?';
    const EXTENDED_DATA_FIELD_WAS_THERE_A_STICKER_ON_THE_BAG_OR_BIN = 'Was there a sticker on the bag/ bin?';
    const EXTENDED_DATA_FIELD_WHEELED_BIN_REFUSE_COLLECTION = 'Wheeled Bin refuse collection';
    const EXTENDED_DATA_FIELD_WHOLE_ROAD_RECYCLING = 'Whole road recycling';
    const EXTENDED_DATA_FIELD_WHOLE_ROAD_REFUSE = 'Whole road refuse';

    const REPORT_MISSED_BIN_EXTENDED_DATA_FIELDS = [
        self::EXTENDED_DATA_FIELD_BULK_BIN_RECYCLING,
        self::EXTENDED_DATA_FIELD_BULK_BIN_REFUSE,
        self::EXTENDED_DATA_FIELD_CLINICAL_WASTE,
        self::EXTENDED_DATA_FIELD_FLATS_ABOVE_SHOPS_REFUSE_SACK_COLLECTION,
        self::EXTENDED_DATA_FIELD_FLATS_ABOVE_SHOPS_RECYCLING_SACK_COLLECTION,
        self::EXTENDED_DATA_FIELD_FOOD_WASTE,
        self::EXTENDED_DATA_FIELD_GARDEN_WASTE_COLLECTION,
        self::EXTENDED_DATA_FIELD_HAS_THE_REST_OF_THE_STREET_BEEN_COLLECTED,
        self::EXTENDED_DATA_FIELD_HOUSEHOLD_REFUSE_SACK_COLLECTION,
        self::EXTENDED_DATA_FIELD_IS_IT_IN_THE_CORRECT_CONTAINER,
        self::EXTENDED_DATA_FIELD_IS_THE_BIN_FULL,
        self::EXTENDED_DATA_FIELD_PAPER_RECYCLING_COLLECTION,
        self::EXTENDED_DATA_FIELD_PLASTIC_RECYCLING_COLLECTION,
        self::EXTENDED_DATA_FIELD_RECYCLING_BOX_COLLECTION,
        self::EXTENDED_DATA_FIELD_WAS_IT_IN_THE_CORRECT_COLLECTION_POINT,
        self::EXTENDED_DATA_FIELD_WAS_IT_OUT_BEFORE_7AM,
        self::EXTENDED_DATA_FIELD_WAS_THERE_A_STICKER_ON_THE_BAG_OR_BIN,
        self::EXTENDED_DATA_FIELD_WHEELED_BIN_REFUSE_COLLECTION,
        self::EXTENDED_DATA_FIELD_WHOLE_ROAD_RECYCLING,
        self::EXTENDED_DATA_FIELD_WHOLE_ROAD_REFUSE
    ];
